...
More than one physical partition can be saved onto the save disk  
...
Cosmos DB throughput is distributed equally across all our physical partitions  
...
Partition column datatype should be String. If column with numeric data is to be used it should be converted to a String  
