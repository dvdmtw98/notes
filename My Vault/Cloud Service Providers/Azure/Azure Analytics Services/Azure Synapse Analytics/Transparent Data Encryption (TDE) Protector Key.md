...
* The DEK that is used to encrypt the data in SQL Pool in Synapse is sent to Key Vault where the Key is encrypted and then stored in a User Table in Synapse
