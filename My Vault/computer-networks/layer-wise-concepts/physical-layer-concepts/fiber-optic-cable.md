...
Mainly used for [Wide Area Network (WAN)](../../wide-area-network/wide-area-network-wan.md)  
...
It is also used by ISP running [Synchronous Optical Network (SONET)](../../wide-area-network/connection-methodologies/synchronous-optical-network-sonet.md) systems