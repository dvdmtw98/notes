...
To access credentials stored in [Azure Key Vault](../../cloud-service-providers/azure/azure-security-services/azure-key-vault.md) from Databricks we needs to create a Secret Scope  
Databricks supports credential passthrough (Advanced Option) which allows to access other services using [Azure Active Directory (AAD)](../../cloud-service-providers/azure/azure-security-services/azure-active-directory/azure-active-directory-aad.md)
