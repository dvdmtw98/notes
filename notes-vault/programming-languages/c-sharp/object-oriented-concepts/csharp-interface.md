...
They have a similar to [[csharp-structs|structures]] and [[csharp-classes|classes]]. [[csharp-methods|Methods]] in Interfaces do not have a declaration (they are only defined similar to [[abstract-and-sealed-class|Abstract]] Methods)  
...
The methods and [[csharp-properties|Properties]] that are declared in a interface when implemented in a class should be public ([[csharp-fields|Fields]] cannot be declared in Interface)
